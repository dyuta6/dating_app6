          ...
          return StatefulBuilder(
            ...
            return AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  const Text("Şunlara bakıyorum:"),
                  SingleChildScrollView(
                    scrollDirection: Axis.horizontal,
                    child: DropdownButton<String>(
                      hint: const Text("Cinsiyet seç"),
                      value: chosenGender,
                      underline: Container(),
                  ...
                  const Text("Bu ülkede yaşayanlar"),
                  SingleChildScrollView(
                    scrollDirection: Axis.horizontal,
                    child: DropdownButton<String>(
                      hint: const Text("Ülke Seç"),
                      value: chosenCountry,
                      underline: Container(),
                      items: [
                        "Austria",
        ...
        if (profileController.allUsersProfileList.isEmpty) {
          ...
          return Center(
            child: Column(
              ...
              children: [
                Text("Arama kriterlerine uygun profil bulunamadı."),
                ElevatedButton(
                  onPressed: () {
